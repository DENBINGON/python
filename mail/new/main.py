...
class MyWin(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.ui.textBrowser_2.append('Program is start ' + datetime.strftime(datetime.now(), "%H:%M:%Sn"))
    def MailPost(self):
        ...
        smtpObj = smtplib.SMTP("ENTER SMTP",PORT)
        smtpObj.starttls()
        smtpObj.login("ENTER MAIL","ENTER PASSWORD")
        for mail in kolv:
